...
def initGame():
	...
	pygame.display.set_caption('AI_project_Flappy Bird')
	return screen
...
def main(mode, policy, agent, modelpath):
	...
	game_start_info = startGame(screen, bird_images, other_images, backgroud_image, cfg, mode)
	...
	endGame(screen, showScore, score, number_images, bird, pipe_sprites, backgroud_image, other_images, base_pos, cfg, mode)
